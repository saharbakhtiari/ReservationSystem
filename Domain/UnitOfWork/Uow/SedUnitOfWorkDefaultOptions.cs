...
namespace Domain.UnitOfWork.Uow
{
    ...
    /// </summary>
    public class SedUnitOfWorkDefaultOptions
    {
        /// <summary>
        ...
        internal SedUnitOfWorkOptions Normalize(SedUnitOfWorkOptions options)
        {
        ...
        public bool CalculateIsTransactional(bool autoValue)
        {
            switch (TransactionBehavior)
            {
                ...
                case UnitOfWorkTransactionBehavior.Auto:
                    return autoValue;
                default:
                    throw new SedException("Not implemented TransactionBehavior value: " + TransactionBehavior);
            }
        }
    }
}