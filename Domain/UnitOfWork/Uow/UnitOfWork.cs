...
namespace Domain.UnitOfWork.Uow
{
    public class UnitOfWork : IUnitOfWork//, ITransientDependency
    {
        ...
        public ISedUnitOfWorkOptions Options { get; private set; }
        ...
        private readonly SedUnitOfWorkDefaultOptions _defaultOptions;

        private Exception _exception;
        private bool _isCompleting;
        private bool _isRolledback;

        public UnitOfWork(IServiceProvider serviceProvider, IOptions<SedUnitOfWorkDefaultOptions> options)
        {
        ...
        public virtual void Initialize(SedUnitOfWorkOptions options)
        {
            Check.NotNull(options, nameof(options));

            if (Options != null)
            {
                throw new SedException("This unit of work is already initialized before!");
            }
        ...
        public void AddDatabaseApi(string key, IDatabaseApi api)
        {
            ...
            {
                throw new SedException("There is already a database API in this unit of work with given key: " + key);
            }
        ...
        public void AddTransactionApi(string key, ITransactionApi api)
        {
            ...
            {
                throw new SedException("There is already a transaction API in this unit of work with given key: " + key);
            }
        ...
        private void PreventMultipleComplete()
        {
            ...
            {
                throw new SedException("Complete is called before!");
            }
        }
