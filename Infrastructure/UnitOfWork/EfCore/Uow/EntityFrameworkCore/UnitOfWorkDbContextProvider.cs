...
{
    //TODO: Implement logic in DefaultDbContextResolver.Resolve in old Sed.
        ...
        where TDbContext : IEfCoreDbContext
    {
        ...
        public TDbContext GetDbContext()
        {
            ...
            if (unitOfWork == null)
            {
                throw new SedException("A DbContext can only be created inside a unit of work!");
            }
        ...
        private TDbContext CreateDbContext(IUnitOfWork unitOfWork, string connectionStringName, string connectionString)
        {
            ...
            using (DbContextCreationContext.Use(creationContext))
            {
                ...
                if (dbContext is ISedEfCoreDbContext sedEfCoreDbContext)
                {
                    sedEfCoreDbContext.Initialize(
                        new SedEfCoreDbContextInitializationContext(
                            unitOfWork
                        )
                    );
                }
