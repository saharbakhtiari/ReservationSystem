    ...
    public class WebElasticClient : AbstractWebElasticClient
    {
            ...
            : base(servers, timeout, ssl, allowSelfSignedServerCert, authenticationMethod)
        {
            ...
            _restClientByHost = servers.ToDictionary(GetServerUrl,
                serverData => restClientFactory.Create(GetServerUrl(serverData), timeout, authenticationMethod, GetCertPath(serverData), GetCertPass(serverData)));
        }
        ...
        private void SafeSendRequest(RestRequest request)
        {
