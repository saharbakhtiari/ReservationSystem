...
{
    public class GetFilteredFootersQueryValidator : AbstractValidator<GetFilteredFootersQuery>
    {
        private readonly IStringLocalizer _localizer;
        private readonly IConfiguration _configuration;
        public GetFilteredFootersQueryValidator(IStringLocalizer localizer, IConfiguration configuration)
        {
