...
{
    public class GetFilteredBookingParticipantsQueryValidator : AbstractValidator<GetFilteredBookingParticipantsQuery>
    {
        private readonly IStringLocalizer _localizer;
        private readonly IConfiguration _configuration;
        public GetFilteredBookingParticipantsQueryValidator(IStringLocalizer localizer, IConfiguration configuration)
        {
