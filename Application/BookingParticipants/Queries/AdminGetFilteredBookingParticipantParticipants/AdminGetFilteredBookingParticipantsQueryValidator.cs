...
{
    public class AdminGetFilteredBookingParticipantsQueryValidator : AbstractValidator<AdminGetFilteredBookingParticipantsQuery>
    {
        private readonly IStringLocalizer _localizer;
        private readonly IConfiguration _configuration;
        public AdminGetFilteredBookingParticipantsQueryValidator(IStringLocalizer localizer, IConfiguration configuration)
        {
