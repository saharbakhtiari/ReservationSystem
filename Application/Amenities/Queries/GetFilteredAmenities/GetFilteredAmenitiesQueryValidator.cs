...
{
    public class GetFilteredAmenitiesQueryValidator : AbstractValidator<GetFilteredAmenitiesQuery>
    {
        private readonly IStringLocalizer _localizer;
        private readonly IConfiguration _configuration;
        public GetFilteredAmenitiesQueryValidator(IStringLocalizer localizer, IConfiguration configuration)
        {
