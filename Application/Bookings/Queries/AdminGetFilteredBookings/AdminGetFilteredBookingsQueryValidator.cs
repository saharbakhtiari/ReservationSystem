...
{
    public class AdminGetFilteredBookingsQueryValidator : AbstractValidator<AdminGetFilteredBookingsQuery>
    {
        private readonly IStringLocalizer _localizer;
        private readonly IConfiguration _configuration;
        public AdminGetFilteredBookingsQueryValidator(IStringLocalizer localizer, IConfiguration configuration)
        {
