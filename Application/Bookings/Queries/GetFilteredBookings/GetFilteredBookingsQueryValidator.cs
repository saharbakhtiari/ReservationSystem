...
{
    public class GetFilteredBookingsQueryValidator : AbstractValidator<GetFilteredBookingsQuery>
    {
        private readonly IStringLocalizer _localizer;
        private readonly IConfiguration _configuration;
        public GetFilteredBookingsQueryValidator(IStringLocalizer localizer, IConfiguration configuration)
        {
