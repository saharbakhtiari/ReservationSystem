...
{
    public class GetFilteredSpacesQueryValidator : AbstractValidator<GetFilteredSpacesQuery>
    {
        private readonly IStringLocalizer _localizer;
        private readonly IConfiguration _configuration;
        public GetFilteredSpacesQueryValidator(IStringLocalizer localizer, IConfiguration configuration)
        {
