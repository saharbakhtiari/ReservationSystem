...
{
    public class GetFilteredBookingHoldsQueryValidator : AbstractValidator<GetFilteredBookingHoldsQuery>
    {
        private readonly IStringLocalizer _localizer;
        private readonly IConfiguration _configuration;
        public GetFilteredBookingHoldsQueryValidator(IStringLocalizer localizer, IConfiguration configuration)
        {
