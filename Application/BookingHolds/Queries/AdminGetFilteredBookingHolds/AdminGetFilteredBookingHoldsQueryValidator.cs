...
{
    public class AdminGetFilteredBookingHoldsQueryValidator : AbstractValidator<AdminGetFilteredBookingHoldsQuery>
    {
        private readonly IStringLocalizer _localizer;
        private readonly IConfiguration _configuration;
        public AdminGetFilteredBookingHoldsQueryValidator(IStringLocalizer localizer, IConfiguration configuration)
        {
