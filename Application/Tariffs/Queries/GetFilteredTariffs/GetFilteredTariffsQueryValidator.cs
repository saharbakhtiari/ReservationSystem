...
{
    public class GetFilteredTariffsQueryValidator : AbstractValidator<GetFilteredTariffsQuery>
    {
        private readonly IStringLocalizer _localizer;
        private readonly IConfiguration _configuration;
        public GetFilteredTariffsQueryValidator(IStringLocalizer localizer, IConfiguration configuration)
        {
