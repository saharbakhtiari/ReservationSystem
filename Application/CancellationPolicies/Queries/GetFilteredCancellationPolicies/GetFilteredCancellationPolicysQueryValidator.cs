...
{
    public class GetFilteredCancellationPolicysQueryValidator : AbstractValidator<GetFilteredCancellationPolicysQuery>
    {
        private readonly IStringLocalizer _localizer;
        private readonly IConfiguration _configuration;
        public GetFilteredCancellationPolicysQueryValidator(IStringLocalizer localizer, IConfiguration configuration)
        {
